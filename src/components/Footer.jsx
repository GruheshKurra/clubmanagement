            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        <h3 className="text-lg font-semibold text-blue-600">Student Club Management System</h3>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            <li className="flex items-center">
                                ...
                                <a href="mailto:info@scms.edu" className="text-gray-600 hover:text-blue-500 transition-colors duration-300">info@scms.edu</a>
                            </li>
                            <li className="flex items-center">
                                <svg className="h-5 w-5 text-gray-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-base text-gray-400">&copy; 2024 Student Club Management System. All rights reserved.</p>
                        <p className="mt-4 md:mt-0 text-base text-gray-400">Developed by: B.PRANITHA, K.SRUJANA REDDY, Y.PUSHKALA</p>
                    </div>
                </div>
            </div>
        </footer>
